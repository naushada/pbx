...
import { KeepaliveService } from 'src/common/keepalive.service';
...
export class AppComponent implements OnInit {
    ...
    // KeepaliveService is injected here (rather than only on the login
    // page) so the heartbeat starts on app boot whenever AuthService
    // rehydrates an existing session from localStorage.
    constructor(
        private router: Router,
        private auth: AuthService,
        private _keepalive: KeepaliveService,  // eslint-disable-line @typescript-eslint/no-unused-vars
    ) {}
